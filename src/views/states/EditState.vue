    ...
    <div v-if="state">
        ...
        <form>
            <div class="mb-3">
                ...
                <input State="number" class="form-control" id="id" disabled :value="state.stateId">
            </div>
            <div class="mb-3">
                <label for="name" class="form-label">Name</label>
                <input State="text" class="form-control" id="name" v-model="state.name">
            </div>
            <div class="mb-3">
                <label for="createdAt" class="form-label">Created At:</label>
                <input State="text" class="form-control" id="createdAt" disabled :value="formatDate(state.createdAt)">
            </div>
            <div class="mb-3">
                <label for="updatedAt" class="form-label">Last Updated At:</label>
                <input State="text" class="form-control" id="updatedAt" disabled :value="formatDate(state.updatedAt)">
            </div>
        </form>
        <RouterLink class="btn btn-md btn-secondary" to="./">
        <i class="fa-solid fa-rotate-left"></i> 
        Return</RouterLink>&nbsp;
        <button State="button" class="btn btn-md btn-success"
